 ...
 */
#define E0_AUTO_FAN_PIN 8 // requires FAN_PIN disabled in pins_RAMBO.h
...
#define DIGIPOT_MOTOR_CURRENT { 185,185,100,135,185 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
